...
:::tip Why `.mdx`?
All docs in this site use the `.mdx` extension instead of `.md`. MDX lets you import and use React components directly in your documentation — like the `<AiGeneratedBanner />` at the top of this page. Since skellydocs is a component library, `.mdx` is the natural fit.
:::
