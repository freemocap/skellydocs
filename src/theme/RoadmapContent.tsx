    ...
    <div className={styles.roadmap}>
      ...
      <div className={styles.roadmapFilters}>
        ...
        <div className={styles.roadmapFilterRow}>
          ...
          <div className={styles.roadmapViewToggle}>
            <button
              className={`${styles.roadmapViewBtn} ${viewMode === "grid" ? styles.roadmapViewBtnActive : ""}`}
            ...
            <button
              className={`${styles.roadmapViewBtn} ${viewMode === "list" ? styles.roadmapViewBtnActive : ""}`}
      ...
      {loading ? (
        ...
        <>
          ...
          <div className={viewMode === "grid" ? styles.roadmapGrid : styles.roadmapList}>
            {filtered.map((item) => (
